...
{
    /// <summary>
    /// Provides an engine optimized to utilize a bare minimum of OpenGL 2.1
    /// </summary>
    public class GL2Engine : GLEngineBase
    {
        #region Platform
        ...
        #region Constructors
        public GL2Engine(object Context) : base(Context)
        {
        }
        #endregion
                ...
                case 1:
                    {
                        ...
                        if (Layout.Equals(EPixelComponent.Raw))
                        {
                            ...
                            //if (Layout.BitDepth == 32 && Layout.Flags.HasFlag(EPixelDefFlags.HasFloats))
                            //    return PixelFormat.DepthComponent;

                            //if (Layout.BitDepth == 24)
                            //    return PixelFormat.DepthComponent;
